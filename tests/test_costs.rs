...
#[test]
fn test_mse() {
    let y_true = arr2(&[[1.], [2.], [3.]]);
    let y_hat = arr2(&[[1.], [0.5], [3.5]]);
...
fn test_accuracy_score() {
    let y_true = arr2(&[[0.], [1.], [1.]]);
    let y_hat = arr2(&[[1.], [1.], [1.]]);

    let error = costs::accuracy_score(y_true.view(), y_hat.view());
    assert_eq!(error, 0.6666667);

    let y_true = arr2(&[[0., 1.], [1., 0.], [1., 0.]]);
    let y_hat = arr2(&[[0.9, 0.1], [0.9, 0.1], [0.9, 0.1]]);
